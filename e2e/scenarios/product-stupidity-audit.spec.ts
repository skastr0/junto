...
const EDGES: CanvasEdge[] = [
  ...
  { id: "e-fire", fromNode: "relay", toNode: "tasks2", fromSide: "bottom", toSide: "top",
    ether: { slot: "output", does: { mode: "enqueue_task", data: { title: "review the completed work", details: "review the completed work" } } } },
  // effect: cron→tasks2 heartbeat
  { id: "e-cron", fromNode: "cron", toNode: "tasks2", fromSide: "bottom", toSide: "right",
    ether: { does: { mode: "enqueue_task", data: { title: "heartbeat check", details: "heartbeat check" } } } },
];
