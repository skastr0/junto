...
describe("resolveControlHome", () => {
  ...
  it("matches the e2e harness contract: HOME sandbox + JUNTO_E2E non-headless", () => {
    // e2e/harness/launch.ts sets HOME=sandbox.homeDir, JUNTO_E2E=1,
  ...
  it("matches headless probe isolation: no HOME, userData + optional JUNTO_BROWSER_HOME", () => {
