    ...
    edges: [
      {
        ...
        toNode: "tasks-cron",
        ether: {
          does: { mode: "enqueue_task", task: { title: "from-cron", details: "from-cron", reason: "scheduler" } },
        },
      },
      {
        id: "e-relay-does",
        ...
        toNode: "tasks-relay",
        ether: {
          does: { mode: "enqueue_task", task: { title: "from-relay", details: "from-relay", reason: "scheduler" } },
        },
      },
