...
export const admitPackagedUpdateIdentity = async (input: {
  ...
  try {
    ...
    if (
      pkg.version !== input.version || receipt.schema !== "junto/package-runtime-provenance/v2" ||
      ...
      build.schema !== "junto/runtime-build-identity/v1" || build.runtime !== "electron-main" || build.sourceCommit !== input.sourceRevision ||
