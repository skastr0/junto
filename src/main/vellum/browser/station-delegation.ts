...
export interface StationBrowserTrust { readonly keyId: string; readonly publicKey: KeyObject; readonly originInstallationId: InstallationId }
...
export const bindStationBrowserRequest = (
  ...
  request: Omit<StationBrowserRequest, "authority" | "originInstallationId" | "agentRef">,
  ...
  return {
    ...request,
    authority: data.kind,
    originInstallationId: data.originInstallationId,
