...
export const QUALIFICATION_WORK_BRIEF =
  "Complete this Junto Station qualification task while Command Center is offline." as const;
export const QUALIFICATION_WORK_COMPLETION_NOTE =
  "Completed the Junto Station qualification task while Command Center was offline." as const;
