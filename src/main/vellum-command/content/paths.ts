...
/** Layout generation under `~/.junto/content/`. */
 ...
 * Default: `<JUNTO_HOME>/.junto/content/v1`.
 */
export const contentStoreRoot = (home: string = resolveJuntoHome()): string =>
  join(home, ".junto", "content", CONTENT_LAYOUT_VERSION);
