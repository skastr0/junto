...
export const CLAUDE_TEMPLATE: ManagedTerminalTemplate = {
  ...
  capabilityBadges: {
    ...
    stateFeed: "hooks → OSC → grid",
    attentionSource: "grid (OSC cannot distinguish permission prompt)",
    labels: ["injection A", "hooks", "effort", "session pin"],
  },
...
export const GROK_TEMPLATE: ManagedTerminalTemplate = {
  ...
  capabilityBadges: {
    ...
    remote: false,
    requiresGitCwd: true,
    stateFeed: "hooks/events.jsonl → OSC → grid",
    attentionSource: "events.jsonl permission_requested + footer",
    labels: ["injection A", "hooks", "effort", "session pin", "git cwd"],
  },
...
export const HERMES_TEMPLATE: ManagedTerminalTemplate = {
  ...
  capabilityBadges: {
    ...
    remote: true,
    requiresGitCwd: false,
    stateFeed: "hooks → OSC (--tui only) → grid",
    attentionSource: "OSC title ⚠",
    labels: ["injection B", "hooks", "no effort flag", "session capture", "remote"],
  },
  efforts: [],
};
