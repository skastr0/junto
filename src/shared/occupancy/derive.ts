...
export const deriveOccupancy = (input: DeriveOccupancyInput): OccupancySpectrum => {
  ...
  // 2. Attention.
  if (harness === "attention") return "attention";

  // 3. Stalled — heartbeat gap (only when lastSeen is known).
  if (
