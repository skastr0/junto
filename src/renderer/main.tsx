...
// Heavy on React Flow canvases — opt out per machine with:
//   localStorage.setItem("vellum:react-scan", "off")
if (import.meta.env.DEV && localStorage.getItem("vellum:react-scan") !== "off") {
