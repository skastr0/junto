  ...
  return (
    <div className="settings-section">
      <FieldRow
        ...
        hint="Allows Deploy Vellum Remote and remote plugin installs. Off by default. Local plugin installs are unaffected."
      >
        <input
          type="checkbox"
      ...
      <p className="settings-note">
        ...
        {isCommandCenter
          ? " Enroll fresh Remote sets up a machine that already has the package installed; Deploy Vellum Remote needs managed installs switched on."
          : ""}
      </p>
