 ...
 *    `src/main/junto/state/**`. Anything else is a second opener and must be
 ...
 *   `src/main/junto/work/repository.ts` IS the work-plane mutation seam. It is
...
const STATE_ENGINE_PREFIX = "src/main/junto/state/";
 ...
 */
const SEAM_MODULE_REL = "src/main/junto/work/mutation-seam.ts";
const STATE_ENGINE_REL = "src/main/junto/state/engine.ts";
